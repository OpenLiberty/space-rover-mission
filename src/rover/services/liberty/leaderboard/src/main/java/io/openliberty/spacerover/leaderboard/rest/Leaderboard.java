...
public class Leaderboard {
	...
	private Response retrieveEntriesFromMongodb(String startTime, String endTime, String gameMode) {
		...
		MongoClient mongoClient = MongoClients.create("mongodb://spaceUser:openliberty@mongo:27017/admin?authSource=admin");
		MongoDatabase database = mongoClient.getDatabase("spaceDB");
		MongoCollection<Document> collection = database.getCollection(LeaderboardConstants.LEADERBOARD_COLLECTION_NAME);
